...
class Mapa(object):
    ...
    def __init__(self):
        # Tilesets (surfaces)
        self.tileset1 = Tileset("tileset_suelos1.png", 32, 32).cortar_tileset()
        self.tileset2 = Tileset("tileset_paredes.png", 32, 32).cortar_tileset()
        self.tileset3 = Tileset("tileset_tejados.png", 32, 32).cortar_tileset()
        self.tileset_enemigos = Tileset("tileset_enemigos.png", 64, 64).cortar_tileset()
