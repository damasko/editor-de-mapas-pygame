...
class Pincel(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.surface = pygame.image.load("res/pincel.png").convert_alpha()
        self.surface_1 = pygame.image.load("res/pincel.png").convert_alpha()
        self.surface_2 = pygame.image.load("res/pincel2.png").convert_alpha()
        self.surface_3 = pygame.image.load("res/pincel3.png").convert_alpha()
